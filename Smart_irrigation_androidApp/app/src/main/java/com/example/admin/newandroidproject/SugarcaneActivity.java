...
String str1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch simpleSwitch = (Switch) findViewById(R.id.switchsugar);
    ...
    private void callAysnkTask1() {
        try {
            new SugarcaneActivity.MyAsyncTask1().execute(str1.toString().trim());
    ...
    private void callAysnkTask() {
        try {
            new SugarcaneActivity.MyAsyncTask().execute(str1.toString().trim());
