...
public class RiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch simpleSwitch = (Switch) findViewById(R.id.switchrice);
    ...
    private void callAysnkTask1() {
        try {
            new RiceActivity.MyAsyncTask1().execute(str1.toString().trim());
    ...
    private void callAysnkTask() {
        try {
            new RiceActivity.MyAsyncTask().execute(str1.toString().trim());
