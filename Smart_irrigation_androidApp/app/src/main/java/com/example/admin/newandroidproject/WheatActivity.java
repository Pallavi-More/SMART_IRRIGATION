...
String str1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch simpleSwitch = (Switch) findViewById(R.id.switchw);
    ...
    private void callAysnkTask1() {
        try {
            new WheatActivity.MyAsyncTask1().execute(str1.toString().trim());
    ...
    private void callAysnkTask() {
        try {
            new WheatActivity.MyAsyncTask().execute(str1.toString().trim());
